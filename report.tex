...
The last method of combination we use is \href{https://github.com/tp2vis/distribute}{\textit{tp2vis}}, which takes the total power image and spoofs a measurement set. The way \textit{tp2vis} accomplishes this is by taking Fourier data from the total power image and sparsely sampling the Fourier data at close spacings. This data can be used with the interferometer data in a joint deconvolution in \textit{tclean}. This should help fill the close-spacing gap created by the interferometer data and subsequently help increase total power information.
